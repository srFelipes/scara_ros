...
odrvc = odrive.find_any(serial_number="20773597524B") # codo and z
odrvh = odrive.find_any(serial_number="206E3591524B") # hombro

# Settings
odrvc.axis0.controller.config.pos_gain = 13
odrvc.axis0.controller.config.vel_limit = 200
odrvc.axis0.trap_traj.config.vel_limit = 200
odrvc.axis1.controller.config.vel_limit = 4.35/1.5
odrvc.axis1.trap_traj.config.vel_limit = 4.35/1.5
odrvc.axis1.controller.config.inertia = 0.17/4
odrvh.axis0.controller.config.vel_limit = 2.5/1.5
odrvh.axis0.trap_traj.config.vel_limit = 2.5/1.5
odrvh.axis0.controller.config.inertia = 0.84/8

odrvc.axis0.controller.config.input_mode = INPUT_MODE_TRAP_TRAJ
odrvc.axis1.controller.config.input_mode = INPUT_MODE_TRAP_TRAJ
odrvh.axis0.controller.config.input_mode = INPUT_MODE_TRAP_TRAJ

odrvh.axis0.min_endstop.config.debounce_ms = 50

# Offset update
odrvc.axis0.min_endstop.config.offset = .5
odrvc.axis1.min_endstop.config.offset = .2
odrvh.axis0.min_endstop.config.offset = .2
